			...
			<div class="col-md-3 left_col menu_fixed">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="${pageContext.request.contextPath }/dev/flatform/main" class="site_title"><i class="fa fa-paw"></i> <span>自助租房</span>
						</a>
					</div>
					...
					<div id="sidebar-menu"
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								<li><a><i class="fa fa-home"></i> 我<span
								...
								<li><a><i class="fa fa-edit"></i> 全部房子<span
									...
									<ul class="nav child_menu">
										<li><a href="${pageContext.request.contextPath }/room/RoomInfoList.html">点击进入</a>
										</li>
									</ul></li>
							</ul>
						</div>
					...
					<div class="sidebar-footer hidden-small">
						<a data-toggle="tooltip" data-placement="top" title="Settings">
							...
							href="${pageContext.request.contextPath }/user/removeUserSession"> <span
						...
						<ul class="nav navbar-nav navbar-right">
							<li class=""><a href="javascript:;"
								...
								<ul class="dropdown-menu dropdown-usermenu pull-right">
									<li><a
										href="${pageContext.request.contextPath }/user/removeUserSession"><i
