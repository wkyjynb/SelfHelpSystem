...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			<div class="x_title">
				<h2>
					自助租房 <i class="fa fa-user"></i><small>${devUserSession.devName}
						- 现在租房有惊喜^_^</small>
				</h2>
				<div class="clearfix"></div>
			</div>
			<div class="x_content">
				<form method="post" action="${requestScope.path}/room/RoomInfoList.html">
				...
				<%--	<li>
					...
					<li>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">住房状态</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
					...
					<li>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">区域</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select id="queryCategoryLevel1" name="addressId" class="form-control">
					...
					<li>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">楼号</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="hidden" name="categorylevel2list" id="categorylevel2list"/>
        						<select name="buildingId" id="queryCategoryLevel2" class="form-control">
				...
				<div class="row">
					<div class="col-sm-5">
						<div class="dataTables_info" id="datatable-responsive_info"
							...
							${pages.thisPage }/${pages.pageCount }页</div>
					</div>
					<div class="col-sm-7">
						<div class="dataTables_paginate paging_simple_numbers"
							id="datatable-responsive_paginate">
							<ul class="pagination">
								<c:if test="${pages.thisPage > 1}">
									...
									<li class="paginate_button "><a
										href="javascript:page_nav(document.forms[0],${pages.thisPage-1});"
										aria-controls="datatable-responsive" data-dt-idx="1"
										tabindex="0">上一页</a>
									</li>
								</c:if>
								<c:if test="${pages.thisPage < pages.pageCount }">
									<li class="paginate_button "><a
										href="javascript:page_nav(document.forms[0],${pages.thisPage+1});"
										aria-controls="datatable-responsive" data-dt-idx="1"
										tabindex="0">下一页</a>
